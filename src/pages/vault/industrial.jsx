...
const GallCG = graphql`
  query GallCG {
    allFile(filter: { relativeDirectory: { eq: "industrial" } }) {
      edges {
        node {
          childImageSharp {
            original {
...
export default function GallCGPage({}) {
  const data = useStaticQuery(GallCG)
  return (
    <CustomBox>
    <Layout>
