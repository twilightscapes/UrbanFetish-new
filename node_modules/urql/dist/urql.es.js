...
function useQuery(e) {
  ...
  var h = [ t, u, e.requestPolicy, e.context, e.pause ];
  var x = i((function() {
    q = !0;
    try {
      return [ s, computeNextState(b, d(s, r)), h ];
    } finally {
      q = !1;
    }
  }));
  ...
  var g = x[1];
  var m = y[1];
  if (s !== y[0] && hasDepsChanged(y[2], h)) {
    g([ s, m = computeNextState(y[1], d(s, r)), h ]);
  }
  o((function() {
    var e = y[0];
    var t = y[2][1];
  ...
  return [ m, a((function(n) {
    ...
    var i = t.executeQuery(u, r);
    g((function(e) {
      var t = "network-only" !== r.requestPolicy ? d(i, !1) : {
        fetching: !0
      };
      var n = computeNextState(e[1], t);
      return e[1] !== n ? [ i, n, e[2] ] : e;
    }));
  }), [ t, u, d, e.requestPolicy, e.context ]) ];
}
...
function useSubscription(e, t) {
  ...
  var x = d[1];
  var y = h[1];
  if (l !== h[0] && hasDepsChanged(h[2], v)) {
    x([ l, y = computeNextState(h[1], {
      fetching: !!l
    }), v ]);
  }
  o((function() {
...
export { y as Consumer, h as Context, Mutation, x as Provider, Query, Subscription, useClient, useMutation, useQuery, useSubscription };
